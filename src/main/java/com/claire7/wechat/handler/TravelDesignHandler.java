 ...
 */
public class TravelDesignHandler implements WxMessageHandler {


    private static TravelDesignHandler instance = null;

    private boolean isRun = false;


    public static synchronized TravelDesignHandler getInstance(){
        if (instance == null) {
            instance = new TravelDesignHandler();
        }
        return instance;
    }
